WITH all_txns as (SELECT account, "tradeAmount"/10^6 as vol, timestamp FROM "Transactions"
     ...
     apr_cohort_b AS (SELECT * FROM mar_accounts WHERE vol > 100),
     apr_cohort_c AS (SELECT * FROM mar_accounts WHERE vol > 1000),
     apr_cohort_d AS (SELECT * FROM mar_accounts WHERE vol > 5000),
     apr_cohort_e AS (SELECT * FROM mar_accounts WHERE vol > 10000),
     apr_cohort_f AS (SELECT * FROM mar_accounts WHERE vol > 50000),
     apr_cohort_g AS (SELECT * FROM mar_accounts WHERE vol > 100000),
     apr_cohort_h AS (SELECT * FROM mar_accounts WHERE vol > 250000),
     apr_cohort_i AS (SELECT * FROM mar_accounts WHERE vol > 500000),
     apr_cohort_j AS (SELECT * FROM mar_accounts WHERE vol > 1000000),
     apr_cohort_k AS (SELECT * FROM mar_accounts WHERE vol > 5000000),
     apr_cohort_l AS (SELECT * FROM mar_accounts WHERE vol > 10000000),
