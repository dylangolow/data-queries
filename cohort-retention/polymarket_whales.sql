WITH all_txns as (SELECT account, "tradeAmount"/10^6 as vol, timestamp FROM "Transactions"
                  WHERE "timestamp" >= '2022-02-01 00:00' and "timestamp" < '2022-05-01 00:00'),
     ...
     "txs" as (SELECT * FROM all_txns
               WHERE account IN (SELECT "account" FROM "feb_cohort") -- swap feb/march cohort here
                 AND "timestamp" >= '2022-02-01 00:00:00' AND "timestamp" < '2022-03-01 00:00:00'), -- swap timestamps here
     ...
     "txs_mar" as (SELECT * FROM all_txns
                   WHERE account IN (SELECT "account" FROM "feb_cohort") -- swap feb/march cohort here
                     AND "timestamp" >= '2022-03-01 00:00:00' AND "timestamp" < '2022-04-01 00:00:00'), -- swap timestamps here
     ...
     "txs_apr" as (SELECT * FROM all_txns
                   WHERE account IN (SELECT "account" FROM "feb_cohort") -- swap feb/march cohort here
                     AND "timestamp" >= '2022-04-01 00:00:00' AND "timestamp" < '2022-05-01 00:00:00'), -- swap timestamps here
