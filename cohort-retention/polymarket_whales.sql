WITH all_txns as (SELECT account, "tradeAmount"/10^6 as vol, timestamp FROM "Transactions"
     ...
     "txs_apr_on_mar_b" as (SELECT * FROM mar_txns WHERE account IN (SELECT "account" FROM "mar_cohort_b")), -- swap feb/march cohort here
     "txs_apr_on_mar_c" as (SELECT * FROM mar_txns WHERE account IN (SELECT "account" FROM "mar_cohort_c")), -- swap feb/march cohort here
     "txs_apr_on_mar_d" as (SELECT * FROM mar_txns WHERE account IN (SELECT "account" FROM "mar_cohort_d")), -- swap feb/march cohort here
     "txs_apr_on_mar_e" as (SELECT * FROM mar_txns WHERE account IN (SELECT "account" FROM "mar_cohort_e")), -- swap feb/march cohort here
     "txs_apr_on_mar_f" as (SELECT * FROM mar_txns WHERE account IN (SELECT "account" FROM "mar_cohort_f")), -- swap feb/march cohort here
     "txs_apr_on_mar_g" as (SELECT * FROM mar_txns WHERE account IN (SELECT "account" FROM "mar_cohort_g")), -- swap feb/march cohort here
     "txs_apr_on_mar_h" as (SELECT * FROM mar_txns WHERE account IN (SELECT "account" FROM "mar_cohort_h")), -- swap feb/march cohort here
     "txs_apr_on_mar_i" as (SELECT * FROM mar_txns WHERE account IN (SELECT "account" FROM "mar_cohort_i")), -- swap feb/march cohort here
     "txs_apr_on_mar_j" as (SELECT * FROM mar_txns WHERE account IN (SELECT "account" FROM "mar_cohort_j")), -- swap feb/march cohort here
     "txs_apr_on_mar_k" as (SELECT * FROM mar_txns WHERE account IN (SELECT "account" FROM "mar_cohort_k")), -- swap feb/march cohort here
     "txs_apr_on_mar_l" as (SELECT * FROM mar_txns WHERE account IN (SELECT "account" FROM "mar_cohort_l")), -- swap feb/march cohort here
     "txs_may_on_mar_b" as (SELECT * FROM mar_txns WHERE account IN (SELECT "account" FROM "mar_cohort_b")), -- swap feb/march cohort here
     "txs_may_on_mar_c" as (SELECT * FROM mar_txns WHERE account IN (SELECT "account" FROM "mar_cohort_c")), -- swap feb/march cohort here
     "txs_may_on_mar_d" as (SELECT * FROM mar_txns WHERE account IN (SELECT "account" FROM "mar_cohort_d")), -- swap feb/march cohort here
     "txs_may_on_mar_e" as (SELECT * FROM mar_txns WHERE account IN (SELECT "account" FROM "mar_cohort_e")), -- swap feb/march cohort here
     "txs_may_on_mar_f" as (SELECT * FROM mar_txns WHERE account IN (SELECT "account" FROM "mar_cohort_f")), -- swap feb/march cohort here
     "txs_may_on_mar_g" as (SELECT * FROM mar_txns WHERE account IN (SELECT "account" FROM "mar_cohort_g")), -- swap feb/march cohort here
     "txs_may_on_mar_h" as (SELECT * FROM mar_txns WHERE account IN (SELECT "account" FROM "mar_cohort_h")), -- swap feb/march cohort here
     "txs_may_on_mar_i" as (SELECT * FROM mar_txns WHERE account IN (SELECT "account" FROM "mar_cohort_i")), -- swap feb/march cohort here
     "txs_may_on_mar_j" as (SELECT * FROM mar_txns WHERE account IN (SELECT "account" FROM "mar_cohort_j")), -- swap feb/march cohort here
     "txs_may_on_mar_k" as (SELECT * FROM mar_txns WHERE account IN (SELECT "account" FROM "mar_cohort_k")), -- swap feb/march cohort here
     "txs_may_on_mar_l" as (SELECT * FROM mar_txns WHERE account IN (SELECT "account" FROM "mar_cohort_l")), -- swap feb/march cohort here
...
--                                            UNION SELECT CONCAT('label_', 'metrics_mar_comp2_apr_l') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_apr_on_mar_l") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "mar_cohort_l") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_apr_on_mar_l"
                                           UNION SELECT CONCAT('label_', 'metrics_mar_comp3_may_b') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_may_on_mar_b") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "mar_cohort_b") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_may_on_mar_b"
                                           UNION SELECT CONCAT('label_', 'metrics_mar_comp3_may_c') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_may_on_mar_c") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "mar_cohort_c") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_may_on_mar_c"
                                           UNION SELECT CONCAT('label_', 'metrics_mar_comp3_may_d') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_may_on_mar_d") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "mar_cohort_d") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_may_on_mar_d"
                                           UNION SELECT CONCAT('label_', 'metrics_mar_comp3_may_e') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_may_on_mar_e") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "mar_cohort_e") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_may_on_mar_e"
                                           UNION SELECT CONCAT('label_', 'metrics_mar_comp3_may_f') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_may_on_mar_f") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "mar_cohort_f") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_may_on_mar_f"
                                           UNION SELECT CONCAT('label_', 'metrics_mar_comp3_may_g') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_may_on_mar_g") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "mar_cohort_g") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_may_on_mar_g"
                                           UNION SELECT CONCAT('label_', 'metrics_mar_comp3_may_h') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_may_on_mar_h") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "mar_cohort_h") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_may_on_mar_h"
--
                                            -- FEB COHORTS                                                                                                                                                                                                                                                                              -- FEB COHORTS
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp1_feb_b') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_feb_on_feb_b") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_b") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_feb_on_feb_b"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp1_feb_c') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_feb_on_feb_c") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_c") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_feb_on_feb_c"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp1_feb_d') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_feb_on_feb_d") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_d") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_feb_on_feb_d"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp1_feb_e') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_feb_on_feb_e") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_e") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_feb_on_feb_e"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp1_feb_f') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_feb_on_feb_f") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_f") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_feb_on_feb_f"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp1_feb_g') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_feb_on_feb_g") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_g") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_feb_on_feb_g"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp1_feb_h') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_feb_on_feb_h") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_h") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_feb_on_feb_h"
--                                            UNION SELECT CONCAT('label_', 'metrics_feb_comp1_feb_i') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_feb_on_feb_i") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_i") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_feb_on_feb_i"
--                                            UNION SELECT CONCAT('label_', 'metrics_feb_comp1_feb_j') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_feb_on_feb_j") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_j") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_feb_on_feb_j"
--                                            UNION SELECT CONCAT('label_', 'metrics_feb_comp1_feb_k') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_feb_on_feb_k") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_k") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_feb_on_feb_k"
--                                            UNION SELECT CONCAT('label_', 'metrics_feb_comp1_feb_l') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_feb_on_feb_l") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_l") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_feb_on_feb_l"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp2_mar_b') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_mar_on_feb_b") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_b") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_mar_on_feb_b"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp2_mar_c') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_mar_on_feb_c") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_c") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_mar_on_feb_c"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp2_mar_d') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_mar_on_feb_d") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_d") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_mar_on_feb_d"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp2_mar_e') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_mar_on_feb_e") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_e") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_mar_on_feb_e"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp2_mar_f') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_mar_on_feb_f") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_f") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_mar_on_feb_f"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp2_mar_g') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_mar_on_feb_g") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_g") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_mar_on_feb_g"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp2_mar_h') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_mar_on_feb_h") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_h") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_mar_on_feb_h"
--                                            UNION SELECT CONCAT('label_', 'metrics_feb_comp2_mar_i') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_mar_on_feb_i") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_i") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_mar_on_feb_i"
--                                            UNION SELECT CONCAT('label_', 'metrics_feb_comp2_mar_j') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_mar_on_feb_j") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_j") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_mar_on_feb_j"
--                                            UNION SELECT CONCAT('label_', 'metrics_feb_comp2_mar_k') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_mar_on_feb_k") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_k") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_mar_on_feb_k"
--                                            UNION SELECT CONCAT('label_', 'metrics_feb_comp2_mar_l') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_mar_on_feb_l") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_l") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_mar_on_feb_l"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp3_apr_b') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_apr_on_feb_b") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_b") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_apr_on_feb_b"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp3_apr_c') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_apr_on_feb_c") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_c") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_apr_on_feb_c"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp3_apr_d') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_apr_on_feb_d") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_d") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_apr_on_feb_d"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp3_apr_e') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_apr_on_feb_e") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_e") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_apr_on_feb_e"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp3_apr_f') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_apr_on_feb_f") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_f") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_apr_on_feb_f"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp3_apr_g') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_apr_on_feb_g") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_g") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_apr_on_feb_g"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp3_apr_h') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_apr_on_feb_h") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_h") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_apr_on_feb_h"
--                                            UNION SELECT CONCAT('label_', 'metrics_feb_comp3_apr_i') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_apr_on_feb_i") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_i") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_apr_on_feb_i"
--                                            UNION SELECT CONCAT('label_', 'metrics_feb_comp3_apr_j') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_apr_on_feb_j") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_j") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_apr_on_feb_j"
--                                            UNION SELECT CONCAT('label_', 'metrics_feb_comp3_apr_k') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_apr_on_feb_k") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_k") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_apr_on_feb_k"
--                                            UNION SELECT CONCAT('label_', 'metrics_feb_comp3_apr_l') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_apr_on_feb_l") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_l") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_apr_on_feb_l"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp4_may_b') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_may_on_feb_b") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_b") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_may_on_feb_b"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp4_may_c') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_may_on_feb_c") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_c") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_may_on_feb_c"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp4_may_d') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_may_on_feb_d") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_d") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_may_on_feb_d"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp4_may_e') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_may_on_feb_e") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_e") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_may_on_feb_e"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp4_may_f') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_may_on_feb_f") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_f") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_may_on_feb_f"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp4_may_g') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_may_on_feb_g") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_g") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_may_on_feb_g"
                                           UNION SELECT CONCAT('label_', 'metrics_feb_comp4_may_h') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_may_on_feb_h") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "feb_cohort_h") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_may_on_feb_h"
                                            -- APR COHORTS
                                           UNION SELECT CONCAT('label_', 'metrics_apr_comp1_apr_b') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_apr_on_apr_b") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "apr_cohort_b") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_apr_on_apr_b"
                                           UNION SELECT CONCAT('label_', 'metrics_apr_comp1_apr_c') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_apr_on_apr_c") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "apr_cohort_c") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_apr_on_apr_c"
                                           UNION SELECT CONCAT('label_', 'metrics_apr_comp1_apr_d') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_apr_on_apr_d") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "apr_cohort_d") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_apr_on_apr_d"
                                           UNION SELECT CONCAT('label_', 'metrics_apr_comp1_apr_e') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_apr_on_apr_e") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "apr_cohort_e") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_apr_on_apr_e"
                                           UNION SELECT CONCAT('label_', 'metrics_apr_comp1_apr_f') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_apr_on_apr_f") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "apr_cohort_f") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_apr_on_apr_f"
                                           UNION SELECT CONCAT('label_', 'metrics_apr_comp1_apr_g') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_apr_on_apr_g") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "apr_cohort_g") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_apr_on_apr_g"
                                           UNION SELECT CONCAT('label_', 'metrics_apr_comp1_apr_h') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_apr_on_apr_h") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "apr_cohort_h") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_apr_on_apr_h"
                                           UNION SELECT CONCAT('label_', 'metrics_apr_comp2_may_b') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_may_on_apr_b") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "apr_cohort_b") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_may_on_apr_b"
                                           UNION SELECT CONCAT('label_', 'metrics_apr_comp2_may_c') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_may_on_apr_c") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "apr_cohort_c") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_may_on_apr_c"
                                           UNION SELECT CONCAT('label_', 'metrics_apr_comp2_may_d') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_may_on_apr_d") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "apr_cohort_d") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_may_on_apr_d"
                                           UNION SELECT CONCAT('label_', 'metrics_apr_comp2_may_e') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_may_on_apr_e") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "apr_cohort_e") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_may_on_apr_e"
                                           UNION SELECT CONCAT('label_', 'metrics_apr_comp2_may_f') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_may_on_apr_f") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "apr_cohort_f") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_may_on_apr_f"
                                           UNION SELECT CONCAT('label_', 'metrics_apr_comp2_may_g') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_may_on_apr_g") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "apr_cohort_g") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_may_on_apr_g"
                                           UNION SELECT CONCAT('label_', 'metrics_apr_comp2_may_h') as label, (CAST((SELECT COUNT(DISTINCT "account") FROM "txs_may_on_apr_h") AS FLOAT) / CAST((SELECT COUNT(DISTINCT "account") FROM "apr_cohort_h") AS FLOAT) ) as percentage, COUNT(DISTINCT "account") as "count" FROM "txs_may_on_apr_h"
     ...
     avg_stats as (SELECT * FROM (
                                     ...
                                     -- ADD 3rd for mar and 2 for apr/apr and apr/may
